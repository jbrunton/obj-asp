...
let reservedWords = [
  ...
  ("method", fun i -> Parser.METHOD i);
  ("Method", fun i -> Parser.MMETHOD i);
  ("fst", fun i -> Parser.FST i);
  ("snd", fun i -> Parser.SND i);
  ("asp", fun i -> Parser.ASP i);
  ("Asp", fun i -> Parser.AASP i);
  ("lab", fun i -> Parser.LAB i);
  ("Lab", fun i -> Parser.LLAB i);
  ("newlab", fun i -> Parser.NEWLAB i);
  ("aspect", fun i -> Parser.ASPECT i);
  ("advice", fun i -> Parser.ADVICE i);
  ("join", fun i -> Parser.JOIN i);
  ("term", fun i -> Parser.TERM i);
  ("type", fun i -> Parser.TYPE i);
